...
public class ReservationAdappter extends RecyclerView.Adapter<ReservationAdappter.ReservationViewHolder> implements ItemTouchHelperAdapter {
    List<Reservation> reservations;
    private final Context context;


    public ReservationAdappter(List<Reservation> reservations, Context context){
